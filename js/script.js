...
const projectDetails = {
    project1: {
        ...
        technologies: ['AWS VPC', 'EKS', 'ALB', 'Auto Scaling', 'Route 53', 'RDS Multi-AZ', 'CloudWatch'],
        impact: [
    ...
    project2: {
        ...
        technologies: ['Jenkins', 'SonarQube', 'Veracode', 'ECR', 'Dependabot', 'OWASP ZAP'],
        impact: [
    ...
    project3: {
        ...
        technologies: ['Terraform', 'AWS', 'S3', 'DynamoDB', 'Terratest', 'Sentinel'],
        impact: [
    ...
    project5: {
        ...
        technologies: ['AWS', 'Lambda', 'EventBridge', 'Cost Explorer', 'CloudWatch', 'Python'],
        impact: [
    ...
    project6: {
        ...
        technologies: ['Prometheus', 'Grafana', 'CloudWatch', 'Alertmanager', 'ELK', 'Jaeger'],
        impact: [
...
function initProjectModalActions() {
    const learnMoreButtons = document.querySelectorAll('.project-learn-more[data-project-id]');
...
function initInteractiveHighlights() {
    ...
    const interactiveChips = document.querySelectorAll(interactiveSelectors.join(', '));
